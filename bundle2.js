(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var point6=new pointObject(28.541011, 77.157927,6);
var point5=new pointObject(28.540815, 77.158387,5);
var point4=new pointObject(28.540625, 77.158857,4);
var point3=new pointObject(28.540400, 77.159352,3);
var point2=new pointObject(28.540751, 77.159586,2);
var point1=new pointObject(28.541156, 77.159763,1);
var point7=new pointObject(28.540797, 77.157756,7);
var point8=new pointObject(28.540331, 77.157415,8);
var point9=new pointObject(28.540012, 77.157066,9);
var sphereKnn=require("sphere-knn");
lookup=sphereKnn([point1,point2,point3,point4,point5,point6,point7,point8,point9]);
options ={
...
function userShuttleDistance(currentPoint,userPoint){
  ...
  return distance;
    ...
    function syncData(shuttlepoint){
      var ShuttleLocObject=database.ref().child('shuttlelocation');
      ShuttleLocObject.set({
          shuttlelatitude: shuttlepoint.latitude,
          shuttlelongitude: shuttlepoint.longitude,
          shuttlepoint: shuttlepoint.pointnum
      });
      document.querySelector("h2").innerHTML="Shuttle is At Point"+shuttlepoint.pointnum;
      var dist=userShuttleDistance(point9.pointnum,shuttlepoint.pointnum);
      document.querySelector("h3").innerHTML="Shuttle is at a distance "+dist+" metre";    
    }
    function display(currPointObj,distkm){
      var shuttlepoint=currPointObj.pointnum;
      syncData(currPointObj);
    }
    function error(evt){
        console.log("error");
    }
